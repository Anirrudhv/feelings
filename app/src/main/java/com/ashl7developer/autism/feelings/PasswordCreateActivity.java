...
public class PasswordCreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ashl7developer.autism.feelings.R.layout.activity_create_password);
        password = (EditText) findViewById(com.ashl7developer.autism.feelings.R.id.etPassword);
    }

    public void onSavePasswordClick(View view) {
        SharedPreferences sharedpreference = getSharedPreferences(
                getString(com.ashl7developer.autism.feelings.R.string.password), Context.MODE_PRIVATE);
