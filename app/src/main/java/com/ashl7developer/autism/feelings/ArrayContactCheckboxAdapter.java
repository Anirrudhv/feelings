    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(
                    com.ashl7developer.autism.feelings.R.layout.item_checkbox, parent, false);
        }

        CheckBox checkBox = (CheckBox) convertView.findViewById(com.ashl7developer.autism.feelings.R.id.checkbox1);
