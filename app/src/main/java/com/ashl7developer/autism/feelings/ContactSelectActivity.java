...
public class ContactSelectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ashl7developer.autism.feelings.R.layout.activity_contacts);

        button1 = (Button) findViewById(com.ashl7developer.autism.feelings.R.id.button1);
        button2 = (Button) findViewById(com.ashl7developer.autism.feelings.R.id.button2);
        button3 = (Button) findViewById(com.ashl7developer.autism.feelings.R.id.button3);
        button4 = (Button) findViewById(com.ashl7developer.autism.feelings.R.id.button4);
        button5 = (Button) findViewById(com.ashl7developer.autism.feelings.R.id.button5);
        saveButton = (Button) findViewById(com.ashl7developer.autism.feelings.R.id.save_button);

        textView1 = (TextView) findViewById(com.ashl7developer.autism.feelings.R.id.textview1);
        textView2 = (TextView) findViewById(com.ashl7developer.autism.feelings.R.id.textview2);
        textView3 = (TextView) findViewById(com.ashl7developer.autism.feelings.R.id.textview3);
        textView4 = (TextView) findViewById(com.ashl7developer.autism.feelings.R.id.textview4);
        textView5 = (TextView) findViewById(com.ashl7developer.autism.feelings.R.id.textview5);
    ...
    void addNewContact(Contact contact, int viewNumber) {
        ...
        if(!textViewList[viewNumber-1].getText().toString().equals(
                getResources().getString(com.ashl7developer.autism.feelings.R.string.no_contact_selected_textview))) {
