    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(
                    com.ashl7developer.autism.feelings.R.layout.item_contact, parent, false);
        }
        TextView tvContactName = (TextView) convertView.findViewById(com.ashl7developer.autism.feelings.R.id.tvContactName);
