...
public class ArrayEmojiAdapter extends ArrayAdapter<Emoji> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(com.ashl7developer.autism.feelings.R.layout.item_emoji, parent, false);
        }
        // Lookup view for data population
        ImageView ivEmoji = (ImageView) convertView.findViewById(com.ashl7developer.autism.feelings.R.id.ivItemEmoji);
