...
public class SendTextFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.ashl7developer.autism.feelings.R.layout.fragment_send_text, container, false);

        sendButton = (Button)view.findViewById(com.ashl7developer.autism.feelings.R.id.send_button);
        emojiName = (TextView)view.findViewById(com.ashl7developer.autism.feelings.R.id.emojy_name_textview);
        emojiPicture = (ImageView)view.findViewById(com.ashl7developer.autism.feelings.R.id.emoji_image_view);
        contactsListView = (ListView)view.findViewById(com.ashl7developer.autism.feelings.R.id.contacts_listview);
