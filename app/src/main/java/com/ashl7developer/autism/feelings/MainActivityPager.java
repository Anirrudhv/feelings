...
public class MainActivityPager extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ashl7developer.autism.feelings.R.layout.activity_main_pager);

        viewPager = (ViewPager) findViewById(com.ashl7developer.autism.feelings.R.id.viewpager);
        viewPager.setAdapter(new PagerAdapterMainActivity(getSupportFragmentManager()));

        tabLayout = (TabLayout) findViewById(com.ashl7developer.autism.feelings.R.id.sliding_tabs);
    ...
    protected void onStart() {
        ...
        SharedPreferences sharedPref = getSharedPreferences(getString(com.ashl7developer.autism.feelings.R.string.password),
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.ashl7developer.autism.feelings.R.menu.menu_main, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.ashl7developer.autism.feelings.R.id.action_setting) {
