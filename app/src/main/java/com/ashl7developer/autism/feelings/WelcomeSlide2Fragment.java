...
public class WelcomeSlide2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.ashl7developer.autism.feelings.R.layout.fragment_welcome_slide2, container, false);
        leftDot = (TextView) v.findViewById(com.ashl7developer.autism.feelings.R.id.left_bullet);
        rightDot = (TextView) v.findViewById(com.ashl7developer.autism.feelings.R.id.right_bullet);
        startButton = (Button) v.findViewById(com.ashl7developer.autism.feelings.R.id.start_app_button);

        startButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPreferences sharedPreferences = getActivity().getSharedPreferences(getString(com.ashl7developer.autism.feelings.R.string.password),
